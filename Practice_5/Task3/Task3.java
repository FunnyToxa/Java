public class Task3 {
	public static void main(String[] args){
		ICalculator calc = new EngineeringCalc();

		System.out.println("Преобразование числа 123 в hex");
		System.out.println(((EngineeringCalc)calc).toHex(123));
		System.out.println("и на оборот:");
		System.out.println(((EngineeringCalc)calc).toDec("7b"));

		System.out.println("рассчет выражений");
		calc.calculate("5 - 4");
		...
		calc.calculate("123 / 0 / 12");
		calc.calculate("1 % 2");
		calc.calculate("1/2/1/3/1/12/3/2/1");
	}
}