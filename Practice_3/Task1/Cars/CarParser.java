public class CarParser{
	public static TempCarParams ParseFromString(String carInStr){
		...
		TempCarParams tmp = new TempCarParams(carInfoArr[0], Integer.valueOf(carInfoArr[1]), Integer.valueOf(carInfoArr[2]));
